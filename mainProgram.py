...
accuracy_p: int = 90                                                      # Acurácia mínima pessoa -> Minimum accuracy person  
accuracy_o: int = 85                                                      # Acurácia mínima onça -> Minimum accuracy jaguar
...
#--------------------------------------------------------------------------------------------------#
        if arg == "alive":
            ...
            if opt.adminBot:
                bot_admin.send_isAlive(opt.name_camera)
#--------------------------------------------------------------------------------------------------#
            if opt.userBot:
                bot_user.send_isAlive(opt.name_camera)
#--------------------------------------------------------------------------------------------------#
        if arg == "change":
...
schedule.every().day.at("10:37").do(checkHour, arg = "alive")
...
#--------------------------------------------------------------------------------------------------#
# Try except to avoid possible erros...
    try:
    ...
    #--------------------------------------------------------------------------------------------------#
            ...
            for i, det in enumerate(pred):                          # detections per image
                ...
                if webcam:                                          # batch_size >= 1 
                    ...
                    im0 = cv2.resize(im0, (640,384))                # Image resize...
                else:
                    p, s, im0 = path, '', im0s
    #--------------------------------------------------------------------------------------------------#    
    ...
    #==================================================================================================#
                ...
                # Take one snap of the image collected:
                    ...
                    if (names[int(cls)] == class_name[0]) and (int(acc) >= accuracy_p):
                        # print(last_ID)
    ...
    #--------------------------------------------------------------------------------------------------#                     
                    ...
                    if (names[int(cls)] == class_name[1]) and (int(acc) >= accuracy_o):
                        # print(last_ID)
